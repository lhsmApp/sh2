...
<body class="no-skin">
				...
				<div class="page-content">
					...
					<div class="page-header">
						...
						<span
							...
							id="subTitle" style="margin-left: 2px;">变动列管理  </span> <span
    ...
    var grid_selector = "#jqGridBase";  
    var pager_selector = "#jqGridBasePager";  
	...
	$(document).ready(function () { 
		...
		$(grid_selector).jqGrid({
			...
			colModel: [
				...
				{ label: '变动字典', name: 'MAPPING_CODE__', width: 60,hidden : true,editable: true,},

				{ label: '账套', name: 'BILL_OFF', width: 60,editable: false, editrules:{required:true},edittype: 'select',formatter:'select',formatoptions:{value:"${billOffStrSelect}"},editoptions:{value:"${billOffStrSelect}"},stype: 'select',searchoptions:{value:"${billOffStrAll}"}},
				{ label: '业务类型', name: 'TYPE_CODE', width: 60,editable: false, editrules:{required:true},edittype: 'select',formatter:'select',formatoptions:{value:"${typeCodeStrSelect}"},editoptions:{value:"${typeCodeStrSelect}"},stype: 'select',searchoptions:{value:"${typeCodeStrAll}"}},
				{ label: '单位', name: 'DEPT_CODE', width: 90,editable: false, editrules:{required:true},edittype: 'select',formatter:'select',formatoptions:{value:"${departmentStrSelect}"},editoptions:{value:"${departmentStrSelect}"},stype: 'select',searchoptions:{value:"${departmentStrAll}"}},
				{ label: '变动字典', name: 'MAPPING_CODE', width: 90,editable: true, editrules:{required:true},edittype: 'select',formatter:'select',formatoptions:{value:"${mappingCodeStrSelect}"},editoptions:{value:"${mappingCodeStrSelect}"},stype: 'select',searchoptions:{value:"${mappingCodeStrAll}"}}
			],
			...
			//rowList: [100,200,500],
            multiSort: true,
			sortname: 'BILL_OFF,TYPE_CODE,DEPT_CODE,MAPPING_CODE',
			altRows: true,
			//rownumbers: true, 
            //rownumWidth: 35,		
