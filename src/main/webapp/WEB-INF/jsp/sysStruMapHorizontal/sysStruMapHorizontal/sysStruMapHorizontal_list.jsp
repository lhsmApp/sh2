...
<body class="no-skin">
	...
	function batchSave(e) {
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>sysStruMapHorizontal/updateAll.do?',
	...
	function tosearch() {
		...
		//$.ajax({
		//	type: "POST",
		//	url: '<%=basePath%>sysStruMapHorizontal/getColCodeSource.do?SelectedCustCol7='+ShowDataCustCol7
    ...
    function SetStructure(){
		...
		$(gridBase_selector).jqGrid({
			url: '<%=basePath%>sysStruMapHorizontal/getPageList.do?SelectedCustCol7='+ShowDataCustCol7
                +'&SelectedTypeCode='+ShowDataTypeCode
                +'&SelectedBusiDate='+ShowDataBusiDate
                +'&SelectedStruMappingTableName='+ShowDataStruMappingTableName,  
			datatype: "json",
	        ...
	        editurl: '<%=basePath%>sysStruMapHorizontal/save.do',
