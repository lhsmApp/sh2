package com.fh.controller.sysStruMapHorizontal.sysStruMapHorizontal;
 ...
 * 数据模板详情
 * 
 * @ClassName: SysStruMapHorizontalController
 ...
 */
@Controller
@RequestMapping(value = "/sysStruMapHorizontal")
public class SysStruMapHorizontalController extends BaseController {

	String menuUrl = "sysStruMapHorizontal/list.do"; // 菜单地址(权限用)
	...
	public ModelAndView list(Page page) throws Exception {
		...
		mv.setViewName("sysStruMapHorizontal/sysStruMapHorizontal/sysStruMapHorizontal_list");
