...
public class SocialIncSummyController extends BaseController {
	...
	String TableNameFirstDetail = "tb_social_inc_summy";
	String TableNameSecondDetail = "tb_social_inc_detail";
	...
	public @ResponseBody PageResult<PageData> getFirstDetailList() throws Exception{
		...
		List<PageData> varList = socialincsummyService.findSummyDetailList(pdCode);	//列出Betting列表
		PageResult<PageData> result = new PageResult<PageData>();
		result.setRows(varList);
	...
	public @ResponseBody PageResult<PageData> getSecondDetailList() throws Exception{
		...
		List<PageData> varList = socialincdetailService.getDetailList(pdCode);	//列出Betting列表
		PageResult<PageData> result = new PageResult<PageData>();
		result.setRows(varList);
	...
	public @ResponseBody CommonBase deleteAll() throws Exception{
        ...
        if(null != listData && listData.size() > 0){
        	socialincsummyService.cancelAll(listData);
			commonBase.setCode(0);
		}
	...
	public @ResponseBody CommonBase summaryDepartString() throws Exception{
		...
		if(listData!=null && listData.size()>0){
			...
			getDetailSetBillCode = socialincdetailService.getSum(pdSetBillCode);
		}
		...
		List<PageData> getSaveDetail = socialincdetailService.getSum(pdDetail);
